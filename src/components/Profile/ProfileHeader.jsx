...
const ProfileHeader = () => {
    ...
    return (
        <Flex gap={{ base: 4, sm: 10 }} py={10} direction={{ base: 'column', sm: 'row' }}>
            <AvatarGroup
                size={{ base: 'xl', md: '2xl' }}
                justifySelf={'center'} alignSelf={'flex-start'}
                mx={'auto'}
            >
                <Avatar src={userProfile.profilePicURL} alt="asaprogrammer" />
            </AvatarGroup>
            ...
            <VStack alignItems={'start'} gap={2} mx={'auto'} flex={1}>
                ...
                <Text fontSize={'sm'} fontWeight={'bold'}>{!userProfile.bio?'Add your bio...':userProfile.bio}</Text>
            </VStack>
